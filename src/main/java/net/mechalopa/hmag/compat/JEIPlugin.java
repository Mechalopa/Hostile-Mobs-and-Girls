package net.mechalopa.hmag.compat;
...
import net.mechalopa.hmag.item.EnchantmentUpgradeItem;
import net.mechalopa.hmag.item.EnchantmentUpgradeItem.Properties.EnchantmentUpgradeProp;
import net.mechalopa.hmag.recipe.EnchantmentUpgradeRecipe;
import net.mechalopa.hmag.recipe.RemoveCurseRecipe;
