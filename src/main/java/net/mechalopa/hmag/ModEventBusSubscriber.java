...
import net.mechalopa.hmag.loot.conditions.ModLoadedCondition;
...
import net.mechalopa.hmag.util.ModBrewingRecipe;
import net.mechalopa.hmag.util.ModSpawnRules;
