...
@OnlyIn(Dist.CLIENT)
public class KoboldModel<T extends MobEntity> extends AbstractGirlModel<T>
{
	...
	public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.rightEar.zRot += MathHelper.sin(ageInTicks * 0.04F) * 0.045F;
		this.leftEar.zRot = (float)Math.PI / 20.0F;
		this.leftEar.zRot += MathHelper.sin(ageInTicks * 0.04F) * -0.045F;
		...
		this.tail2.xRot += MathHelper.sin(ageInTicks * 0.09F + (float)Math.PI / 8.0F) * 0.09F;
		this.tail3.xRot = (float)Math.PI / 12.0F;
		this.tail3.xRot += MathHelper.sin(ageInTicks * 0.09F + (float)Math.PI / 4.0F) * 0.09F;
