...
import net.mechalopa.hmag.item.AncientShieldItem;
import net.mechalopa.hmag.item.CrimsonBowItem;
import net.mechalopa.hmag.item.EXPBerryItem;
import net.mechalopa.hmag.item.EnchantmentUpgradeItem;
import net.mechalopa.hmag.item.EndlessPearlItem;
import net.mechalopa.hmag.item.EvilFlameItem;
import net.mechalopa.hmag.item.EvilThornItem;
import net.mechalopa.hmag.item.FortressShieldItem;
import net.mechalopa.hmag.item.InsomniaSwordItem;
import net.mechalopa.hmag.item.InvincibleBlockItem;
import net.mechalopa.hmag.item.LightningSoupItem;
import net.mechalopa.hmag.item.ModArmorMaterial;
import net.mechalopa.hmag.item.ModFoodItem;
import net.mechalopa.hmag.item.ModItem;
import net.mechalopa.hmag.item.ModSwordItem;
import net.mechalopa.hmag.item.NemesisBladeItem;
import net.mechalopa.hmag.item.NetherStarBlockItem;
import net.mechalopa.hmag.item.PurificationClothItem;
import net.mechalopa.hmag.item.ThrowableBottleItem;
