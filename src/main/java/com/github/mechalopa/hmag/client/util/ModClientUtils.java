...
public class ModClientUtils
{
	...
	public static PartDefinition addPD(PartDefinition partdefinition, CubeDeformation cubeDeformation, String name, int xTexOffs, int yTexOffs, float xp, float yp, float zp, float xSize, float ySize, float zSize, float xOffs, float yOffs, float zOffs, float extend)
	{
		return addPD(partdefinition, cubeDeformation.extend(extend), name, xTexOffs, yTexOffs, xp, yp, zp, xSize, ySize, zSize, xOffs, yOffs, zOffs);
	}

	public static PartDefinition addPD(PartDefinition partdefinition, CubeDeformation cubeDeformation, String name, int xTexOffs, int yTexOffs, float xp, float yp, float zp, float xSize, float ySize, float zSize, float xOffs, float yOffs, float zOffs, boolean isMirror, float extend)
	{
		return addPD(partdefinition, cubeDeformation.extend(extend), name, xTexOffs, yTexOffs, xp, yp, zp, xSize, ySize, zSize, xOffs, yOffs, zOffs, isMirror);
	}

	public static PartDefinition addPD(PartDefinition partdefinition, CubeDeformation cubeDeformation, String name, int xTexOffs, int yTexOffs, float xp, float yp, float zp, float xSize, float ySize, float zSize, float xOffs, float yOffs, float zOffs)
	{
		return addPD(partdefinition, cubeDeformation, name, xTexOffs, yTexOffs, xp, yp, zp, xSize, ySize, zSize, xOffs, yOffs, zOffs, false);
	}

	public static PartDefinition addPD(PartDefinition partdefinition, CubeDeformation cubeDeformation, String name, int xTexOffs, int yTexOffs, float xp, float yp, float zp, float xSize, float ySize, float zSize, float xOffs, float yOffs, float zOffs, boolean isMirror)
	{
		return partdefinition.addOrReplaceChild(name, CubeListBuilder.create().texOffs(xTexOffs, yTexOffs).mirror(isMirror).addBox(xp, yp, zp, xSize, ySize, zSize, cubeDeformation), PartPose.offset(xOffs, yOffs, zOffs));
	}
}