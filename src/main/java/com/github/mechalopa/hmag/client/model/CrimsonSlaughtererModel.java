...
//		this.leftArmPart = this.leftArm.getChild("left_arm_part");
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition headpd = ModClientUtils.addC(pd, "head", 0, 0, -3.0F, 1.0F, -3.0F, 6.0F, 6.0F, 6.0F, 1.0F, 0.0F, f, 0.0F);
		ModClientUtils.addC(headpd, "hat", 32, 0, -4.0F, 0.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.5F, 0.0F, 0.0F, 0.0F);
		...
		PartPose pp = PartPose.offset(-((float)b1) + 1.0F, 0.0F, 0.0F);
		...
		PartDefinition l2bpd = l2apd.addOrReplaceChild("leg_2b", cubelistbuilder3, pp1);
		PartDefinition l3bpd = l3apd.addOrReplaceChild("leg_3b", cubelistbuilder2, pp);
		PartDefinition l4bpd = l4apd.addOrReplaceChild("leg_4b", cubelistbuilder3, pp1);
		PartDefinition l5bpd = l5apd.addOrReplaceChild("leg_5b", cubelistbuilder2, pp);
		PartDefinition l6bpd = l6apd.addOrReplaceChild("leg_6b", cubelistbuilder3, pp1);
		...
		PartPose pp2 = PartPose.offset(0.0F, -(float)b1 + 1.0F, 0.0F);
		PartDefinition l1cpd = l1bpd.addOrReplaceChild("leg_1c", cubelistbuilder4, pp2);
		PartDefinition l2cpd = l2bpd.addOrReplaceChild("leg_2c", cubelistbuilder5, pp2);
		PartDefinition l3cpd = l3bpd.addOrReplaceChild("leg_3c", cubelistbuilder4, pp2);
		PartDefinition l4cpd = l4bpd.addOrReplaceChild("leg_4c", cubelistbuilder5, pp2);
		PartDefinition l5cpd = l5bpd.addOrReplaceChild("leg_5c", cubelistbuilder4, pp2);
		PartDefinition l6cpd = l6bpd.addOrReplaceChild("leg_6c", cubelistbuilder5, pp2);
		...
		PartPose pp3 = PartPose.offset(0.0F, (float)b2 - 0.5F, 0.0F);
		PartDefinition l1dpd = l1cpd.addOrReplaceChild("leg_1d", cubelistbuilder6, pp3);
		PartDefinition l2dpd = l2cpd.addOrReplaceChild("leg_2d", cubelistbuilder7, pp3);
		PartDefinition l3dpd = l3cpd.addOrReplaceChild("leg_3d", cubelistbuilder6, pp3);
		PartDefinition l4dpd = l4cpd.addOrReplaceChild("leg_4d", cubelistbuilder7, pp3);
		PartDefinition l5dpd = l5cpd.addOrReplaceChild("leg_5d", cubelistbuilder6, pp3);
		PartDefinition l6dpd = l6cpd.addOrReplaceChild("leg_6d", cubelistbuilder7, pp3);
		...
		PartPose pp4 = PartPose.offset(0.0F, (float)b3 - 1.0F, 0.0F);
		l1dpd.addOrReplaceChild("leg_1e", cubelistbuilder8, pp4);
		l2dpd.addOrReplaceChild("leg_2e", cubelistbuilder9, pp4);
		l3dpd.addOrReplaceChild("leg_3e", cubelistbuilder8, pp4);
		l4dpd.addOrReplaceChild("leg_4e", cubelistbuilder9, pp4);
		l5dpd.addOrReplaceChild("leg_5e", cubelistbuilder8, pp4);
		l6dpd.addOrReplaceChild("leg_6e", cubelistbuilder9, pp4);
