...
{
	private static final RenderType RENDER_TYPE_0 = RenderType.eyes(new ResourceLocation(HMaG.MODID, "textures/entity/jiangshi/jiangshi_eyes_0.png"));
	private static final RenderType RENDER_TYPE_1 = RenderType.eyes(new ResourceLocation(HMaG.MODID, "textures/entity/jiangshi/jiangshi_eyes_1.png"));
