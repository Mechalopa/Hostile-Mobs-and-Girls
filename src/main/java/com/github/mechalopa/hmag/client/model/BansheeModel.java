...
public class BansheeModel<T extends AbstractFlyingMonsterEntity> extends AbstractGirlModel<T>
{
	...
	public BansheeModel(float modelSize)
	{
		...
		this.bodyPart1.addBox(-2.5F, 0.0F, -1.0F, 5.0F, 2.0F, 2.0F, modelSize);
		...
		this.rightHairPart2.addBox(-1.0F, -1.5F, -1.0F, 2.0F, 5.0F, 2.0F, modelSize);
		...
		this.rightHairPart3.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, modelSize + 0.25F);
		...
		this.rightHairPart4.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, modelSize);
		...
		this.rightHairPart5.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, modelSize);
		...
		this.leftHairPart2.addBox(-1.0F, -1.5F, -1.0F, 2.0F, 5.0F, 2.0F, modelSize);
		...
		this.leftHairPart3.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, modelSize + 0.25F);
		...
		this.leftHairPart4.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, modelSize);
		...
		this.leftHairPart5.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, modelSize);
		...
		this.ribbonRightPart1.addBox(-2.5F, -2.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize - 0.25F);
		...
		this.ribbonRightPart2.addBox(-0.5F, -2.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize - 0.25F);
		...
		this.ribbonLeftPart1.addBox(-2.5F, -2.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize - 0.25F);
		...
		this.ribbonLeftPart2.addBox(-0.5F, -2.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize - 0.25F);
