...
public abstract class AbstractAdvancedGirlModel<T extends LivingEntity> extends AbstractGirlModel<T>
{
	...
	public static MeshDefinition createMesh(CubeDeformation cd, float yOffset, int bodyHeight)
	{
		...
		PartDefinition bodypd = ModClientUtils.addC(pd, cd, "body", 16, 16, -3.0F, 0.0F, -1.5F, 6.0F, bodyHeight, 3.0F, 0.0F, 0.0F + yOffset, 0.0F);
		PartDefinition bodypart1pd = ModClientUtils.addC(bodypd, cd, "body_part_1", 32, 32, -2.5F, 0.0F, -1.0F, 5.0F, 3.0F, 2.0F, 0.0F, bodyHeight, 0.0F);
