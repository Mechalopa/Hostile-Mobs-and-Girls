...
public class GiantMummyModel<T extends Mob> extends HumanoidModel<T>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition bodypd = ModClientUtils.addC(pd, "body", 0, 50, -8.0F, 0.0F, -5.0F, 16.0F, 10.0F, 10.0F, 0.0F, f, 0.0F);
		PartDefinition bp1pd = ModClientUtils.addC(bodypd, "body_part_1", 0, 70, -6.0F, 0.0F, -4.5F, 12.0F, 3.0F, 9.0F, 0.0F, 10.0F, 0.0F);
		ModClientUtils.addC(bp1pd, "body_part_2", 0, 82, -4.5F, 0.0F, -3.5F, 9.0F, 6.0F, 7.0F, 0.0F, 3.0F, 0.0F);
		PartDefinition rapd = ModClientUtils.addC(pd, "right_arm", 40, 0, -4.0F, -2.0F, -2.0F, 5.0F, 12.0F, 6.0F, -8.75F, 1.0F + f, -0.5F, 0.005F);
		PartDefinition lapd = ModClientUtils.addC(pd, "left_arm", 64, 0, -1.0F, -2.0F, -2.0F, 5.0F, 12.0F, 6.0F, 8.75F, 1.0F + f, -0.5F, 0.005F);
		PartDefinition rap1pd = ModClientUtils.addC(rapd, "right_arm_part_1", 40, 18, -4.0F, -2.0F, -2.0F, 5.0F, 13.0F, 6.0F, 0.0F, 10.0F, 0.0F);
		PartDefinition lap1pd = ModClientUtils.addC(lapd, "left_arm_part_1", 64, 18, -1.0F, -2.0F, -2.0F, 5.0F, 13.0F, 6.0F, 0.0F, 10.0F, 0.0F);
		...
		ModClientUtils.addC(rlp1pd, "right_leg_part_2", 0, 34, -3.0F, -2.0F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, 8.0F, 0.0F);
		ModClientUtils.addC(llp1pd, "left_leg_part_2", 20, 34, -2.0F, -2.0F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, 8.0F, 0.0F);
