...
import com.github.mechalopa.hmag.item.AncientShieldItem;
import com.github.mechalopa.hmag.item.CrimsonBowItem;
import com.github.mechalopa.hmag.item.EXPBerryItem;
import com.github.mechalopa.hmag.item.EnchantmentUpgradeItem;
import com.github.mechalopa.hmag.item.EndlessPearlItem;
import com.github.mechalopa.hmag.item.EvilFlameItem;
import com.github.mechalopa.hmag.item.EvilThornItem;
import com.github.mechalopa.hmag.item.FortressShieldItem;
import com.github.mechalopa.hmag.item.InsomniaSwordItem;
import com.github.mechalopa.hmag.item.InvincibleBlockItem;
import com.github.mechalopa.hmag.item.LightningSoupItem;
import com.github.mechalopa.hmag.item.ModArmorMaterial;
import com.github.mechalopa.hmag.item.ModFoodItem;
import com.github.mechalopa.hmag.item.ModItem;
import com.github.mechalopa.hmag.item.ModSwordItem;
import com.github.mechalopa.hmag.item.NemesisBladeItem;
import com.github.mechalopa.hmag.item.NetherStarBlockItem;
import com.github.mechalopa.hmag.item.PurificationClothItem;
import com.github.mechalopa.hmag.item.ThrowableBottleItem;
...
public class ModItems
{
	...
	public static final RegistryObject<Item> SILVER_NUGGET = REGISTRY.register("silver_nugget", () -> new Item(new Item.Properties().tab(HMaG.MODTAB)));
	public static final RegistryObject<Item> RUBY_FRAGMENT = REGISTRY.register("ruby_fragment", () -> new Item(new Item.Properties().tab(HMaG.MODTAB)));
	public static final RegistryObject<Item> SAPPHIRE_FRAGMENT = REGISTRY.register("sapphire_fragment", () -> new Item(new Item.Properties().tab(HMaG.MODTAB)));
	...
	public static final RegistryObject<Item> REINFORCING_PLATE = REGISTRY.register("reinforcing_plate", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.UNBREAKING, 0, 2)));
	...
	public static final RegistryObject<Item> WICKED_WHETSTONE_TIER_1 = REGISTRY.register("wicked_whetstone_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.SHARPNESS, 5, 6)));
	public static final RegistryObject<Item> WICKED_WHETSTONE_TIER_2 = REGISTRY.register("wicked_whetstone_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.SHARPNESS, 7, 9)));
	public static final RegistryObject<Item> POWERFUL_BOWSTRING_TIER_1 = REGISTRY.register("powerful_bowstring_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.POWER_ARROWS, 5, 6)));
	public static final RegistryObject<Item> POWERFUL_BOWSTRING_TIER_2 = REGISTRY.register("powerful_bowstring_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.POWER_ARROWS, 7, 9)));
	public static final RegistryObject<Item> REINFORCED_PROTECTOR_TIER_1 = REGISTRY.register("reinforced_protector_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.ALL_DAMAGE_PROTECTION, 4, 6)));
	public static final RegistryObject<Item> REINFORCED_PROTECTOR_TIER_2 = REGISTRY.register("reinforced_protector_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil().setResistanceType(ModItem.ResistanceType.INVINCIBLE), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.ALL_DAMAGE_PROTECTION, 7, 9)));
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_1 = REGISTRY.register("shard_of_greed_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.MOB_LOOTING, 3, 4)));
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_2 = REGISTRY.register("shard_of_greed_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.MOB_LOOTING, 5, 6)));
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_3 = REGISTRY.register("shard_of_greed_tier_3", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.EPIC).fireResistant(), new ModItem.Properties().foil().setResistanceType(ModItem.ResistanceType.INVINCIBLE), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.MOB_LOOTING, 7, 9)));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_1 = REGISTRY.register("shard_of_fortune_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.BLOCK_FORTUNE, 3, 4)));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_2 = REGISTRY.register("shard_of_fortune_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.BLOCK_FORTUNE, 5, 6)));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_3 = REGISTRY.register("shard_of_fortune_tier_3", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.EPIC).fireResistant(), new ModItem.Properties().foil().setResistanceType(ModItem.ResistanceType.INVINCIBLE), new EnchantmentUpgradeItem.Properties().enchantment(Enchantments.BLOCK_FORTUNE, 7, 9)));
