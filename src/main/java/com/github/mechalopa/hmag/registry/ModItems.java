...
public class ModItems
{
	...
	public static final RegistryObject<Item> COOKED_RAVAGER_MEAT = REGISTRY.register("cooked_ravager_meat", () -> new Item(new Item.Properties().tab(HMaG.MODTAB).food((new FoodProperties.Builder()).nutrition(8).saturationMod(0.8F).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 30 * 20, 0), 0.2F).effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 10 * 20, 0), 0.2F).meat().build())));
