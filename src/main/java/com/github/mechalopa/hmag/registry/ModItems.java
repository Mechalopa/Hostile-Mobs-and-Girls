...
public class ModItems
{
	...
	public static final RegistryObject<Item> CURE_BERRY = REGISTRY.register("cure_berry", () -> new ModFoodItem(new Item.Properties().tab(HMaG.MODTAB).food((new FoodProperties.Builder()).nutrition(2).saturationMod(0.4F).alwaysEat().build()), new ModFoodItem.Properties().healAmount(4.0F)));
