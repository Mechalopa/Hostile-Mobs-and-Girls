...
public class NewerEnchantmentUpgradeRecipe extends AbstractNewerUpgradeRecipe
{
	public NewerEnchantmentUpgradeRecipe(ResourceLocation recipeId)
	{
		super(recipeId);
	}
	...
	{
		return stack.getItem() != Items.ENCHANTED_BOOK && !stack.is(ModTags.ENCHANTMENT_NOT_UPGRADEABLES);
	}

	@Override
	public boolean isAdditionIngredient(ItemStack stack)
	{
		return stack.getItem() != null && stack.getItem() instanceof EnchantmentUpgradeItem && stack.is(ModTags.ENCHANTMENT_UPGRADE_ITEMS);
	}

	@Override
	public RecipeSerializer<?> getSerializer()
	{
		return ModRecipes.NEWER_ENCHANTMENT_UPGRADE.get();
	}
}