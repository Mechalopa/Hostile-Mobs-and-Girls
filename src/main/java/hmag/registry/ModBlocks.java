...
import hmag.HMaG;
import hmag.block.HealingSandBlock;
import hmag.block.ModBlock;
import hmag.block.PoisonSandBlock;
import hmag.block.ReinforcedBlock;
import hmag.block.ReinforcedGlassBlock;
import hmag.block.ThornSandBlock;
import hmag.block.WitherSandBlock;
...
public class ModBlocks
{
	...
	public static final RegistryObject<Block> ANCIENT_STONE_BLOCK = REGISTRY.register("ancient_stone_block", () -> new ModBlock(AbstractBlock.Properties.of(Material.STONE, MaterialColor.COLOR_BROWN).requiresCorrectToolForDrops().strength(1.25F, 4.2F).lightLevel((state) -> 5).sound(SoundType.STONE), 1.0F));
	public static final RegistryObject<Block> NETHER_STAR_BLOCK = REGISTRY.register("nether_star_block", () -> new ModBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(2.0F, 2000.0F).lightLevel((state) -> 10).sound(SoundType.STONE), 5.0F));
