...
public class ModItems
{
	...
	public static final RegistryObject<Item> IRON_SPEAR = REGISTRY.register("iron_spear", () -> new ModSwordItem(ItemTier.IRON, new Item.Properties().tab(HMaG.MODTAB)));
	...
	public static final RegistryObject<Item> FORTRESS_SHIELD = REGISTRY.register("fortress_shield", () -> new FortressShieldItem(new Item.Properties().tab(HMaG.MODTAB).durability(588).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_1 = REGISTRY.register("shard_of_greed_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), Enchantments.MOB_LOOTING, 3));
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_2 = REGISTRY.register("shard_of_greed_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), Enchantments.MOB_LOOTING, 4));
	public static final RegistryObject<Item> SHARD_OF_GREED_TIER_3 = REGISTRY.register("shard_of_greed_tier_3", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.EPIC).fireResistant(), new ModItem.Properties().foil(), Enchantments.MOB_LOOTING, 5, 9));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_1 = REGISTRY.register("shard_of_fortune_tier_1", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.UNCOMMON), Enchantments.BLOCK_FORTUNE, 3));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_2 = REGISTRY.register("shard_of_fortune_tier_2", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.RARE), new ModItem.Properties().foil(), Enchantments.BLOCK_FORTUNE, 4));
	public static final RegistryObject<Item> SHARD_OF_FORTUNE_TIER_3 = REGISTRY.register("shard_of_fortune_tier_3", () -> new EnchantmentUpgradeItem(new Item.Properties().tab(HMaG.MODTAB).rarity(Rarity.EPIC).fireResistant(), new ModItem.Properties().foil().setResistanceType(ModItem.ResistanceType.INVINCIBLE), Enchantments.BLOCK_FORTUNE, 5, 9));
