...
public class MeltyMonsterModel<T extends MeltyMonsterEntity> extends AbstractGirlModel<T>
{
	...
	public MeltyMonsterModel(float modelSize, boolean isOverlay)
	{
		...
		this.rightLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 7, 2, modelSize);
		this.rightLeg.setPos(-1.75F, 12.0F, 0.0F);
		this.leftLeg = new ModelRenderer(this, 0, 16);
		this.leftLeg.mirror = true;
		this.leftLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 7, 2, modelSize);
		this.leftLeg.setPos(1.75F, 12.0F, 0.0F);

		this.rightArmPart = new ModelRenderer(this, 16, 56);
		this.rightArmPart.addBox(-0.5F, 0.0F, -1.5F, 3, 4, 3, modelSize);
		...
		this.leftArmPart.addBox(-2.5F, 0.0F, -1.5F, 3, 4, 3, modelSize);
		...
		this.rightLegPart.addBox(-1.5F, 0.0F, -1.5F, 3, 5, 3, modelSize);
		...
		this.leftLegPart.addBox(-1.5F, 0.0F, -1.5F, 3, 5, 3, modelSize);
		...
		this.rightHairAPart1.addBox(-1.0F, -1.0F, -1.0F, 2, 3, 2, modelSize);
		...
		this.rightHairAPart2.addBox(-1.0F, -1.5F, -1.0F, 2, 5, 2, modelSize);
		...
		this.rightHairAPart3.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, modelSize + 0.25F);
		...
		this.rightHairAPart4.addBox(-1.5F, 0.0F, -1.5F, 3, 3, 3, modelSize);
		...
		this.rightHairAPart5.addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2, modelSize);
		...
		this.leftHairAPart1.addBox(-1.0F, -1.0F, -1.0F, 2, 3, 2, modelSize);
		...
		this.leftHairAPart2.addBox(-1.0F, -1.5F, -1.0F, 2, 5, 2, modelSize);
		...
		this.leftHairAPart3.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, modelSize + 0.25F);
		...
		this.leftHairAPart4.addBox(-1.5F, 0.0F, -1.5F, 3, 3, 3, modelSize);
		...
		this.leftHairAPart5.addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2, modelSize);
		...
		this.leftHairBPart1.addBox(-1.0F, -1.0F, -1.0F, 2, 3, 2, modelSize);
		...
		this.leftHairBPart2.addBox(-1.0F, -1.5F, -1.0F, 2, 5, 2, modelSize);
		...
		this.leftHairBPart3.addBox(-1.0F, 0.0F, -1.0F, 2, 6, 2, modelSize + 0.25F);
		...
		this.leftHairBPart4.addBox(-1.5F, 0.0F, -1.5F, 3, 3, 3, modelSize);
		...
		this.leftHairBPart5.addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2, modelSize);
