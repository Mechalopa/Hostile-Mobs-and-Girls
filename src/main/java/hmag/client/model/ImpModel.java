...
public class ImpModel<T extends MobEntity> extends AbstractGirlModel<T>
{
	...
	public ImpModel(float modelSize)
	{
		...
		this.rightFeelerPart1.addBox(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, modelSize);
		this.rightFeelerPart1.setPos(-1.75F, -8.0F, -0.75F);
		this.head.addChild(this.rightFeelerPart1);
		this.leftFeelerPart1 = new ModelRenderer(this, 0, 64);
		this.leftFeelerPart1.mirror = true;
		this.leftFeelerPart1.addBox(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 1.0F, modelSize);
		this.leftFeelerPart1.setPos(1.75F, -8.0F, -0.75F);
		...
		this.rightHair.setPos(-4.5F, -7.5F, 2.25F);
		...
		this.leftHair.setPos(4.5F, -7.5F, 2.25F);
		this.head.addChild(this.leftHair);

		this.rightHair2 = new ModelRenderer(this, 48, 64);
		this.rightHair2.addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, modelSize + 0.25F);
		...
		this.leftHair2.addBox(-1.0F, -0.5F, -1.0F, 2.0F, 3.0F, 2.0F, modelSize + 0.25F);
		...
		this.rightHair3.setPos(0.0F, 2.5F, 0.0F);
		...
		this.leftHair3.setPos(0.0F, 2.5F, 0.0F);
		...
		for (int i = 0; i < this.rightSkirtPart.length; ++i)
		{
			...
			this.rightSkirtPart[i].addBox(-1.5F, 0.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize);
			...
			this.leftSkirtPart[i].addBox(-1.5F, 0.5F, -1.0F, 3.0F, 5.0F, 1.0F, modelSize);
	...
	public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.rightFeelerPart1.xRot += MathHelper.sin(ageInTicks * 0.09F) * 0.066F;
		this.leftFeelerPart1.xRot += MathHelper.sin(ageInTicks * 0.09F) * 0.066F;
		this.rightFeelerPart2.xRot = (float)Math.PI / 6.0F;
		this.leftFeelerPart2.xRot = (float)Math.PI / 6.0F;
		this.rightFeelerPart2.xRot += MathHelper.sin(ageInTicks * 0.09F + (float)Math.PI / 3.0F) * 0.075F;
		this.leftFeelerPart2.xRot += MathHelper.sin(ageInTicks * 0.09F + (float)Math.PI / 3.0F) * 0.075F;
