...
public class DoguModel<T extends MobEntity> extends BipedModel<T>
{
	...
	public DoguModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn)
	{
		...
		this.rightArmPart3.addBox(-2.0F, 0.0F, -2.0F, 4, 4, 4, modelSize);
		...
		this.leftArmPart3.addBox(-2.0F, 0.0F, -2.0F, 4, 4, 4, modelSize);
		...
		this.leftArmPart4.addBox(-1.5F, 0.0F, -1.5F, 3, 1, 3, modelSize);
		...
		this.rightLegPart1.addBox(-2.5F, 0.0F, -2.5F, 5, 4, 5, modelSize);
		...
		this.rightLegPart2.addBox(-2.0F, 0.0F, -2.0F, 4, 2, 4, modelSize);
		...
		this.rightLegPart3.addBox(-1.5F, 0.0F, -1.5F, 3, 2, 3, modelSize);
		...
		this.leftLegPart2.addBox(-2.0F, 0.0F, -2.0F, 4, 2, 4, modelSize);
		...
		this.leftLegPart3.addBox(-1.5F, 0.0F, -1.5F, 3, 2, 3, modelSize);
