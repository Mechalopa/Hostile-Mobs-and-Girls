...
public class ArurauneModel<T extends MobEntity> extends AbstractGirlModel<T>
{
	...
	public ArurauneModel(float modelSize)
	{
		...
		this.leftHair.addBox(-0.5F, -1.0F, 0.0F, 1, 10, 1, modelSize + 0.25F);
		this.leftHair.setPos(4.0F, -8.0F, 1.5F);
		this.head.addChild(this.leftHair);

		this.rightHair2 = new ModelRenderer(this, 32, 48);
		this.rightHair2.addBox(-1.0F, -0.5F, -0.5F, 2, 6, 1, modelSize);
		...
		this.leftHair3.addBox(-1.0F, -0.5F, -0.5F, 2, 5, 1, modelSize);
		...
		this.rightHairFlowerA.setPos(-0.5F, 0.5F, 0.25F);
		...
		this.rightHairFlowerB.setPos(-0.5F, 0.5F, 0.25F);
		...
		this.rightHairFlowerC.setPos(-0.5F, 0.5F, 0.25F);
		...
		this.rightHairFlowerD.setPos(-0.5F, 0.5F, 0.25F);
		...
		this.leftHairFlowerA.setPos(0.5F, 0.5F, 0.25F);
		...
		this.leftHairFlowerB.setPos(0.5F, 0.5F, 0.25F);
		...
		this.leftHairFlowerC.setPos(0.5F, 0.5F, 0.25F);
		...
		this.leftHairFlowerD.setPos(0.5F, 0.5F, 0.25F);
		...
		for (int i = 0; i < this.rightSkirtLeafPart1.length; ++i)
		{
			...
			this.rightSkirtLeafPart1[i].addBox(-2.5F, 0.5F, 0.0F, 5, 6, 1, modelSize);
			...
			this.leftSkirtLeafPart1[i].addBox(-2.5F, 0.5F, 0.0F, 5, 6, 1, modelSize);
			...
			this.rightSkirtLeafPart2[i].addBox(-2.5F, 0.0F, 0.0F, 5, 5, 1, modelSize);
			...
			this.leftSkirtLeafPart2[i].addBox(-2.5F, 0.0F, 0.0F, 5, 5, 1, modelSize);
			...
			this.rightSkirtLeafPart3[i].addBox(-2.5F, 0.0F, 0.0F, 5, 4, 1, modelSize);
			...
			this.leftSkirtLeafPart3[i].addBox(-2.5F, 0.0F, 0.0F, 5, 4, 1, modelSize);
		...
		this.rightTentaclePartA.addBox(-0.5F, -5.75F, -0.5F, 1, 6, 1, modelSize + 0.25F);
		this.rightTentaclePartA.setPos(-2.0F, 4.5F, 1.5F);
		...
		this.leftTentaclePartA.addBox(-0.5F, -5.75F, -0.5F, 1, 6, 1, modelSize + 0.25F);
		this.leftTentaclePartA.setPos(2.0F, 4.5F, 1.5F);
		...
		this.rightLegPart.addBox(-1.5F, 0.0F, -1.5F, 3, 6, 3, modelSize + 0.5F);
		...
		this.leftLegPart.addBox(-1.5F, 0.0F, -1.5F, 3, 6, 3, modelSize + 0.5F);
	...
	public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		float f = ((float)Math.PI / 24.0F) + MathHelper.sin(ageInTicks * 0.075F) * 0.045F;
		...
		this.rightTentaclePartA.zRot -= MathHelper.sin(ageInTicks * 0.045F - (float)Math.PI / 3.0F) * 0.021F;
		this.leftTentaclePartA.zRot += MathHelper.sin(ageInTicks * 0.045F - (float)Math.PI / 3.0F) * 0.021F;
		this.rightTentaclePartA.xRot = -((float)Math.PI * 2.0F / 5.0F);
		this.leftTentaclePartA.xRot = -((float)Math.PI * 2.0F / 5.0F);
		this.rightTentaclePartA.xRot += MathHelper.sin(ageInTicks * 0.048F) * 0.075F;
		...
		this.rightTentaclePartB.xRot = ((float)Math.PI * 2.0F / 5.0F);
		this.leftTentaclePartB.xRot = ((float)Math.PI * 2.0F / 5.0F);
		this.rightTentaclePartB.xRot -= MathHelper.sin(ageInTicks * 0.045F + (float)Math.PI / 2.0F) * 0.075F;
		this.leftTentaclePartB.xRot += MathHelper.sin(ageInTicks * 0.045F - (float)Math.PI / 2.0F) * 0.075F;
		...
		this.rightTentaclePartC.xRot += MathHelper.sin(ageInTicks * 0.045F - (float)Math.PI / 4.0F) * 0.075F;
		this.leftTentaclePartC.xRot += MathHelper.sin(ageInTicks * 0.045F - (float)Math.PI / 2.0F) * 0.075F;
		...
		this.leftTentaclePartD.xRot += MathHelper.sin(ageInTicks * 0.042F + (float)Math.PI / 3.0F) * 0.06F;
		...
		if (this.attackTime > 0.0F)
		{
			...
			this.rightTentaclePartB.xRot += f3 * 0.045F + f4;
			this.leftTentaclePartB.xRot += f3 * 0.045F + f4;
