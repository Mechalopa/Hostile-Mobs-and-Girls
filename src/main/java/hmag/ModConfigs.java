...
//	public static ForgeConfigSpec.IntValue CCC;
	...
	public static ForgeConfigSpec.IntValue STONEULAR_SPAWN_WEIGHT;
...
//
//		CCC = CLIENT_BUILDER.defineInRange("", 0, 0, 1);
//
//		CLIENT_BUILDER.pop();
//
//		CLIENT_CONFIG = CLIENT_BUILDER.build();
		...
		STONEULAR_SPAWN_WEIGHT = SERVER_BUILDER.defineInRange("stoneularSpawnWeight", 15, 0, Integer.MAX_VALUE);
	...
	public static class cachedServer
	{
		...
		public static int STONEULAR_SPAWN_WEIGHT;
		...
		public static void refresh()
		{
			...
			STONEULAR_SPAWN_WEIGHT = ModConfigs.STONEULAR_SPAWN_WEIGHT.get();
